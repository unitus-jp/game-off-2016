...
#include "mscorlib_System_Security_SecureString412202620MethodDeclarations.h"
...
IL_0065:
		{
			...
			NullCheck(L_24);
			IL2CPP_RUNTIME_CLASS_INIT(Marshal_t785896760_il2cpp_TypeInfo_var);
			Marshal_WriteInt16_m1012726579(NULL /*static, unused*/, L_23, ((int32_t)((int32_t)4+(int32_t)(((int32_t)((int32_t)(((Il2CppArray *)L_24)->max_length)))))), 0, /*hidden argument*/NULL);
