...
extern "C"  float Text_get_preferredHeight_m452532789 (Text_t356221433 * __this, const MethodInfo* method)
{
	...
	float V_2 = 0.0f;
	{
		...
		V_1 = L_0;
		float L_1 = Rect_get_x_m1393582490((&V_1), /*hidden argument*/NULL);
		Vector2_t2243707579  L_2;
		memset(&L_2, 0, sizeof(L_2));
		Vector2__ctor_m3067419446(&L_2, L_1, (0.0f), /*hidden argument*/NULL);
		TextGenerationSettings_t2543476768  L_3 = Text_GetGenerationSettings_m3659206515(__this, L_2, /*hidden argument*/NULL);
		V_0 = L_3;
		TextGenerator_t647235000 * L_4 = Text_get_cachedTextGeneratorForLayout_m1357670532(__this, /*hidden argument*/NULL);
		String_t* L_5 = __this->get_m_Text_29();
		TextGenerationSettings_t2543476768  L_6 = V_0;
		NullCheck(L_4);
		float L_7 = TextGenerator_GetPreferredHeight_m274483688(L_4, L_5, L_6, /*hidden argument*/NULL);
		float L_8 = Text_get_pixelsPerUnit_m1202765365(__this, /*hidden argument*/NULL);
